...
const totalPopulation   = populations.reduce(function(total, element){
...
const bobsTotal = purchases.filter(obj => obj.owner === "Bob").map(function (obj) {return obj["price"];}).reduce(function (acc, curr) { return acc + curr });
